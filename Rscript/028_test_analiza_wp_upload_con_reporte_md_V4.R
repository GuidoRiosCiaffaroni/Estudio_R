...
# ─────────────────────────────────────────────────────────────────────────────
#  PRUEBAS CON `testthat` Y REPORTE EN FORMATO MARKDOWN (.md) COMPLETO
# ─────────────────────────────────────────────────────────────────────────────
...
# Ejecutar el test y capturar la salida completa con errores y advertencias
...
writeLines(paste0("**Fecha:** ", Sys.time()), con = con_md)
writeLines("
## Resultado de ejecución
", con = con_md)
for (linea in test_output) {
  writeLines(paste0("    ", linea), con = con_md)
}
close(con_md)
...
message("✅ Pruebas ejecutadas y reporte Markdown generado COMPLETO en: ", reporte_md)
